...
import { KinetixV3PoolSwapTest } from '../typechain/KinetixV3PoolSwapTest'
...
describe('KinetixV3Pool arbitrage tests', () => {
      ...
      for (const passiveLiquidity of [
        ...
        describe(`passive liquidity of ${formatTokenAmount(passiveLiquidity)}`, () => {
          const arbTestFixture = async ([wallet, arbitrageur]: Wallet[]) => {
            ...
            const testerFactory = await ethers.getContractFactory('KinetixV3PoolSwapTest')
            const tester = (await testerFactory.deploy()) as KinetixV3PoolSwapTest
          ...
          let tester: KinetixV3PoolSwapTest
