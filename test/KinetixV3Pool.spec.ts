...
import { TestKinetixV3SwapPay } from '../typechain/TestKinetixV3SwapPay'
...
import { TestKinetixV3ReentrantCallee } from '../typechain/TestKinetixV3ReentrantCallee'
...
describe('KinetixV3Pool', () => {
  ...
  let factory: KinetixV3Factory
  let pool: MockTimeKinetixV3Pool

  let swapTarget: TestKinetixV3Callee
  ...
  async function initializeAtZeroTick(pool: MockTimeKinetixV3Pool): Promise<void> {
    await pool.initialize(encodePriceSqrt(1, 1))
  ...
  describe('#lock', () => {
    ...
    it('cannot reenter from swap callback', async () => {
      const reentrant = (await (
        await ethers.getContractFactory('TestKinetixV3ReentrantCallee')
      ).deploy()) as TestKinetixV3ReentrantCallee
  ...
  describe('swap underpayment tests', () => {
    let underpay: TestKinetixV3SwapPay
    beforeEach('deploy swap test', async () => {
      const underpayFactory = await ethers.getContractFactory('TestKinetixV3SwapPay')
      underpay = (await underpayFactory.deploy()) as TestKinetixV3SwapPay
